...
def main():
    experiment_name='logreg_multiple_heat_models'

    # Specify models to use in experiments
    model_names = ['logreg',
                'logreg_heat_past_only', 
                'logreg_heat_past_present', 
                ...
                'logreg_concat_exclude_present_in_heat_present_future',
                'logreg_concat_exclude_present_in_heat_past_future'
                ]
