...
run_experiment(
    model_names=["learnable_heat_lstm_heat_concat_single_layer_with_linear_layer_tanh"],
    ...
    hyperparams_to_search={
        "learning_rate": [0.0001, 0.001, 0.01, 0.1],
        "epochs": [100],
        "epsilon_prior": [0.0001, 0.001, 0.01, 0.1],
        "beta_prior": [0.0001, 0.001, 0.01, 0.1],
        "dropout": [0, 0.25, 0.50],
        # "lstm1_hidden_dim": [64,128,256, 512],
        # "lstm2_hidden_dim": [64,128,256, 512],
        "lstm_hidden_dim_global": [128, 256, 512],
